...
Vagrant::Config.run do |config|
  ...
  config.vm.box_url = "http://staff.vpac.org/~aspiers/centos-63-x64.box"
  ...
  config.vm.provision :puppet do |puppet|
    ...
    puppet.options = ["--modulepath", "modules", "--verbose", "--debug", 
		      "--fileserverconfig=/vagrant/vagrantfileserver.conf",
